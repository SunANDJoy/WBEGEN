...
## Instruction
- We uploaded the jupyter notebook file named _access_models.ipynb_ along with the _Adipose_Subcutaneous_m.Rdata_ file.
...
```
1. Locate the imputaion model file (Here: Adipose Subcutaneous_m.Rdata) and access_models.ipynb in the same directory.
